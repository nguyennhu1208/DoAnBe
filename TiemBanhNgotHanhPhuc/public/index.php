                ...
                foreach ($list_of_latestProducts as $key => $value) {
                    ...
                    <div class="item">
                        <div class="cake_feature_item">
                            <div class="cake_img">
                                <img src="img/cake-feature/<?php echo $value['pro_image']; ?>" alt="" width="270px"
                                    height="224px">
                            </div>
                            <div class="cake_text">
                                <h4><?php echo $value['price']; ?></h4>
                                <h3><a
                                        href="product-details.php?id=<?php echo $value['id']; ?>"><?php echo $value['name']; ?></a>
                                </h3>
                    ...
                    <div class="col-lg-6">
                        <div class="discover_item_inner">
                            <div class="discover_item">
                                ...
                                <p><?php echo $value['description']; ?><span><?php echo number_format($value['price']) ?>
                                        VND</span></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <p>Osed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque
                                ...
                                quia non numquam qui ratione voluptatem sequi nesciunt.
    ...
    <div class="container">
        <div class="row our_chef_inner">
            ...
            <div class="col-lg-3 col-6">
                <div class="chef_item">
                    <div class="chef_img">
                        <img class="img-fluid" src="img/chef/sieu.png" alt="">
                        <ul class="list_style">
            ...
            <div class="col-lg-3 col-6">
                <div class="chef_item">
                    <div class="chef_img">
                        <img class="img-fluid" src="img/chef/nhinhi.png" alt="" style="height: 236px;">
                        <ul class="list_style">
                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="fa fa-linkedin-square"></i></a></li>
                            <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
            ...
            <div class="col-lg-3 col-6">
                <div class="chef_item">
                    <div class="chef_img">
                        <img class="img-fluid" src="img/chef/bahuy.png" alt="">
                        <ul class="list_style">
                            <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="#"><i class="fa fa-linkedin-square"></i></a></li>
                            <li><a href="#"><i class="fa fa-facebook-square"></i></a></li>
...
<!--================Latest News Area =================-->
<?php
$getLatestReview = Review::getLatestReview();
?>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="l_news_image">
                    <div class="l_news_img">
                        <img class="img-fluid"
                            src="./img/cake-feature/<?= Product::getProduct_ByID($getLatestReview[0]['product_id'])['pro_image'] ?>"
                            alt="" style="height: 400px;">
                    </div>
                    <div class="l_news_hover">
                        <a href="./product-details.php?id=<?= $getLatestReview[0]['product_id'] ?>" target="_blank">
                            <h5><?php $time = strtotime($getLatestReview[0]['created_at']);
                            echo $mysqldate = date('F j, Y', $time); ?></h5>
                        </a>
                        <a href="./product-details.php?id=<?= $getLatestReview[0]['product_id'] ?>" target="_blank">
                            <h4><?= $getLatestReview[0]['reviewer_name'] ?></h4>
                        </a>
                        <p><?= $getLatestReview[0]['content'] ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="l_news_item">
                    <div class="l_news_img">
                        <img class="img-fluid"
                            src="./img/cake-feature/<?= Product::getProduct_ByID($getLatestReview[1]['product_id'])['pro_image'] ?>"
                            alt="">
                    </div>
                    <div class="l_news_text">
                        <a href="./product-details.php?id=<?= $getLatestReview[1]['product_id'] ?>" target="_blank">
                            <h5><?php $time = strtotime($getLatestReview[1]['created_at']);
                            echo $mysqldate = date('F j, Y', $time); ?></h5>
                        </a>
                        <a href="./product-details.php?id=<?= $getLatestReview[1]['product_id'] ?>" target="_blank">
                            <h4><?= $getLatestReview[1]['reviewer_name'] ?></h4>
                        </a>
                        <p><?= $getLatestReview[1]['content'] ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="l_news_item">
                    <div class="l_news_img">
                        <img class="img-fluid"
                            src="./img/cake-feature/<?= Product::getProduct_ByID($getLatestReview[2]['product_id'])['pro_image'] ?>"
                            alt="">
                    </div>
                    <div class="l_news_text">
                        <a href="./product-details.php?id=<?= $getLatestReview[2]['product_id'] ?>" target="_blank">
                            <h5><?php $time = strtotime($getLatestReview[2]['created_at']);
                            echo $mysqldate = date('F j, Y', $time); ?></h5>
                        </a>
                        <a href="./product-details.php?id=<?= $getLatestReview[2]['product_id'] ?>" target="_blank">
                            <h4><?= $getLatestReview[2]['reviewer_name'] ?></h4>
                        </a>
                        <p><?= $getLatestReview[2]['content'] ?></p>
                    </div>
                </div>
            </div>
        </div>
