                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr class="">
                                        ...
                                        <td>
                                            <h5><?php echo $value['feature']; ?></h5>
                                        </td>
                                        <td>
                                            <h5><?php echo $value['receipt']; ?></h5>
                                        </td>
                                        <td>
                                            <h5><?php echo $value['created_at']; ?></h5>
                                        </td>
                                        <td>
...
<!--Footer-part-->
<div class="row-fluid">
    <div id="footer" class="span12"> 2024 &copy; TDC - Lập trình BackEn - Nhóm 6</div>
</div>
<!--end-Footer-part-->
