        ...
        <div class="main-w3l">
            ...
            <div class="w3layouts-main">
                ...
                <form action="./check-login-register.php" method="POST">
                    ...
                    <div class="field-group" style="text-align: center; color: #000;">
                        <input type="checkbox" name="remember" id="remember" <?php if (isset($_COOKIE["member_login"])) { ?> checked<?php } ?> />
                        <label for="remember-me">Remember me</label>

                    </div>
                    <!-- Thông báo Remember Me -->
                    <?php $rememberSuccess = isset($rememberSuccess) ? $rememberSuccess : false; ?>
                    <?php if ($rememberSuccess): ?>
                        <div style="text-align: center; color: green;">
                            Remember Me successfully set!
                        </div>
                    <?php endif; ?>

                    <!-- Nút Submit -->
                    <input type="submit" value="Signin" name="login">
                    <button type="button" data-toggle="modal" class="btn btn-outline-success rounded-pill"
                        data-target="#exampleModal" id="register">
            ...
            <div class="footer-w3l">
                <p>&copy; 2023 Space Login Form. All rights reserved | Design by <a
